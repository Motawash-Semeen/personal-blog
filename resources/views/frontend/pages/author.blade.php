...
@section('content')
    <section class="d-flex flex-column align-items-center">
        ...
        <h6 class="sidebar-title section-title mb-4 mt-3">About Author</h6>
        ...
        <p class="text-center p-100">Founder of WowThemes.net and creator of "Mediumish" theme that you're currently
            ...
            reach me out on the social links below.</p>
    </section>
    <hr>
    <div class="page-container">
        <div class="page-content">
            <h3 class="text-center pb-4">My Posts</h3>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card text-center mb-5">
                        ...
                        <div class="card-body px-0">
                            ...
                            <p class="my-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos saepe dolores et
                                nostrum porro odit reprehenderit animi, est ratione fugit aspernatur ipsum. Nostrum placeat
                                hic saepe voluptatum dicta ipsum beatae.</p>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="card text-center mb-5">
                        ...
                        <div class="card-body px-0">
                            ...
                            <p class="my-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos saepe dolores
                                et nostrum porro odit reprehenderit animi, est ratione fugit aspernatur ipsum. Nostrum
