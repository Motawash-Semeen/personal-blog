                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group my-4">
                        ...
                        <div class="col-12 col-md-9">
                            ...
                            <img class="mt-3"
                                src="{{ $gallary->image ? asset('backend/images/gallary') . '/' . $gallary->image : asset('backend/images/post/na.png') }}"
                    ...
                    <div class="row form-group my-4">
                        ...
                        <div class="col-12 col-md-9">
                            <select name="status" id="" class="form-control">
                                ...
                                <option value=1 @if ($gallary->status == 1)
                                  selected
                                @endif>Active</option>
                                <option value=0 @if ($gallary->status == 0)
                                  selected
